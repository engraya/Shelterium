...
function PropertyContactBox({ contactName, phoneNumber } : ContactProps) {
  const { theme } = useTheme();
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl font-bold text-center leading-tight text-black dark:text-white">
        Property Contact
      </h3>
      <div>
      <div className="text-center font-bold leading-relaxed text-gray-900 dark:text-body-color-dark">
          Contact Name
      </div>
...
export default PropertyContactBox
